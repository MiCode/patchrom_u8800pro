...
.method private createCommonTables(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    .prologue
    .line 672
    const-string v0, "CREATE TABLE canonical_addresses (_id INTEGER PRIMARY KEY,address TEXT,recent INTEGER);"
...
.method public static updateAllThreads(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;[Ljava/lang/String;)V
    ...
    const-string v3, "_id NOT IN (SELECT DISTINCT thread_id FROM sms UNION SELECT DISTINCT channel_id FROM cbs_messages UNION SELECT DISTINCT thread_id FROM pdu)"
...
.method public static updateThread(Landroid/database/sqlite/SQLiteDatabase;J)V
    ...
    invoke-static {p0, p1, p2}, Lcom/android/providers/telephony/MmsSmsDatabaseHelper;->updateAllThreads(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;[Ljava/lang/String;)V
    ...
    .restart local p1
    :cond_1
    invoke-static {p0, p1, p2}, Lcom/android/providers/telephony/Utils;->isOther(Landroid/database/sqlite/SQLiteDatabase;J)Z
    ...
    const-string v1, "  UPDATE threads  SET  date =    (SELECT date FROM        (SELECT date * 1000 AS date, thread_id FROM pdu         UNION SELECT date, thread_id FROM sms)     WHERE thread_id = "
    ...
    const-string v1, " ORDER BY date DESC LIMIT 1),"
    ...
    const-string v1, "        (SELECT date * 1000 AS date, sub AS snippet, thread_id FROM pdu"

    invoke-virtual {v0, v1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v0

    const-string v1, "         UNION SELECT date, body AS snippet, thread_id FROM sms)"
    ...
    const-string v1, "        (SELECT date * 1000 AS date, sub_cs AS snippet_cs, thread_id FROM pdu"

    invoke-virtual {v0, v1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v0

    const-string v1, "         UNION SELECT date, 0 AS snippet_cs, thread_id FROM sms)"
...
.method public onCreate(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    .line 385
    invoke-static {p1}, Lcom/android/providers/telephony/CbsMessages;->onCreate(Landroid/database/sqlite/SQLiteDatabase;)V
...
.method public onUpgrade(Landroid/database/sqlite/SQLiteDatabase;II)V
    ...
    .line 1122
    invoke-static {p1}, Lcom/android/providers/telephony/CbsMessages;->onUpgrade(Landroid/database/sqlite/SQLiteDatabase;)V

...
.method getUsimExtensionEfForAdnEf(I)I
    ...
    .line 152
    .local v1, Ext1tag:I
    sget-object v6, Lcom/android/internal/telephony/UiccConstants$AppType;->APPTYPE_USIM:Lcom/android/internal/telephony/UiccConstants$AppType;

    iget-object v7, p0, Lcom/android/internal/telephony/AdnRecordCache;->mFh:Lcom/android/internal/telephony/IccFileHandler;

    iget-object v7, v7, Lcom/android/internal/telephony/IccFileHandler;->mApplication:Lcom/android/internal/telephony/UiccCardApplication;

    invoke-virtual {v7}, Lcom/android/internal/telephony/UiccCardApplication;->getType()Lcom/android/internal/telephony/UiccConstants$AppType;
    ...
    invoke-virtual {v6}, Lcom/android/internal/telephony/gsm/UsimPhoneBookManager;->getPbrFileSize()I
    ...
    invoke-virtual {v6, v4, v0}, Lcom/android/internal/telephony/gsm/UsimPhoneBookManager;->getEFidInPBR(II)I
    ...
    invoke-virtual {v6, v4, v1}, Lcom/android/internal/telephony/gsm/UsimPhoneBookManager;->getEFidInPBR(II)I
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    .line 467
    :cond_0
    invoke-direct {p0, v9, v2}, Lcom/android/internal/telephony/AdnRecordCache;->notifyWaiters(Ljava/util/ArrayList;Landroid/os/AsyncResult;)V
    ...
    .line 478
    invoke-virtual {v1, v3}, Lcom/android/internal/telephony/AdnRecord;->setEfid(I)V

    .line 479
    invoke-virtual {v1, v5}, Lcom/android/internal/telephony/AdnRecord;->setRecordNumber(I)V

    .line 485
    :cond_1
    sput v3, Lcom/android/internal/telephony/AdnRecordCache;->s_efid:I

    .line 486
    sput v5, Lcom/android/internal/telephony/AdnRecordCache;->s_index:I
    ...
    invoke-virtual {v10}, Lcom/android/internal/telephony/gsm/UsimPhoneBookManager;->getPhonebookRecords()Ljava/util/ArrayList;

    move-result-object v10

    iput-object v10, p0, Lcom/android/internal/telephony/AdnRecordCache;->mPhoneBookRecords:Ljava/util/ArrayList;

    .line 503
    iget-object v10, p0, Lcom/android/internal/telephony/AdnRecordCache;->mPhoneBookRecords:Ljava/util/ArrayList;
    ...
    invoke-virtual {v6, v1}, Lcom/android/internal/telephony/AdnRecord;->equalAdn(Lcom/android/internal/telephony/AdnRecord;)Z
    ...
    invoke-virtual {v10, v4, v1}, Ljava/util/ArrayList;->set(ILjava/lang/Object;)Ljava/lang/Object;
    ...
    .restart local v6       #record:Lcom/android/internal/telephony/AdnRecord;
...
.method public updateAdnBySearchForUsim(ILcom/android/internal/telephony/AdnRecord;Lcom/android/internal/telephony/AdnRecord;Ljava/lang/String;Landroid/os/Message;)V
    ...
    const-string v6, "mUsimPhoneBookManager is null/EF id is not pbr:"
    ...
    invoke-virtual {v5}, Lcom/android/internal/telephony/gsm/UsimPhoneBookManager;->getPbrFileSize()I
    ...
    invoke-virtual {v0, v1, v2}, Lcom/android/internal/telephony/gsm/UsimPhoneBookManager;->getEFidInPBR(II)I
    ...
    .line 334
    .local v17, oldAdnList:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Lcom/android/internal/telephony/AdnRecord;>;"
    if-nez v17, :cond_5
    ...
    .end local v17           #oldAdnList:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Lcom/android/internal/telephony/AdnRecord;>;"
    :cond_7
    const/4 v5, -0x1

...
.method private endFile(Landroid/media/MediaScanner$FileCacheEntry;ZZZZZ)Landroid/net/Uri;
    ...
    #getter for: Landroid/media/MediaScanner;->isDrmAudio:Z
    invoke-static {v5}, Landroid/media/MediaScanner;->access$800(Landroid/media/MediaScanner;)Z
    ...
    #getter for: Landroid/media/MediaScanner;->isDrmVideo:Z
    ...
    #getter for: Landroid/media/MediaScanner;->isDrmImage:Z
    invoke-static {v5}, Landroid/media/MediaScanner;->access$1000(Landroid/media/MediaScanner;)Z
    ...
    invoke-static {v5}, Landroid/media/MediaScanner;->access$1800(Landroid/media/MediaScanner;)Landroid/content/IContentProvider;
    ...
    invoke-static {v5}, Landroid/media/MediaScanner;->access$2000(Landroid/media/MediaScanner;)Ljava/util/HashMap;
...
.method private toValues()Landroid/content/ContentValues;
    ...
    const-string/jumbo v3, "toValues....mPath : "
    ...
    #getter for: Landroid/media/MediaScanner;->isDrmAudio:Z
    invoke-static {v2}, Landroid/media/MediaScanner;->access$800(Landroid/media/MediaScanner;)Z
    ...
    #getter for: Landroid/media/MediaScanner;->isDrmImage:Z
    invoke-static {v2}, Landroid/media/MediaScanner;->access$1000(Landroid/media/MediaScanner;)Z
    ...
    #getter for: Landroid/media/MediaScanner;->rawDrmFileType:Ljava/lang/String;
    invoke-static {v2}, Landroid/media/MediaScanner;->access$500(Landroid/media/MediaScanner;)Ljava/lang/String;
    ...
    invoke-static {v2}, Landroid/media/MediaFile;->getRealMimeType(Ljava/lang/String;)Landroid/media/MediaFile$MediaFileType;
    ...
    .line 714
    iget-object v2, v0, Landroid/media/MediaFile$MediaFileType;->mimeType:Ljava/lang/String;
    ...
    const-string v3, "mMimeType changed : "
    ...
    #getter for: Landroid/media/MediaScanner;->isDrmFile:Z
    ...
    #getter for: Landroid/media/MediaScanner;->canForward:Z
...
.method public addNoMediaFolder(Ljava/lang/String;)V
    ...
    #getter for: Landroid/media/MediaScanner;->mMediaProvider:Landroid/content/IContentProvider;
    invoke-static {v3}, Landroid/media/MediaScanner;->access$1800(Landroid/media/MediaScanner;)Landroid/content/IContentProvider;
...
.method public beginFile(Ljava/lang/String;Ljava/lang/String;JJ)Landroid/media/MediaScanner$FileCacheEntry;
    ...
    .line 513
    const-string v6, "ro.config.hwdrm"
    ...
    #setter for: Landroid/media/MediaScanner;->rawDrmFileType:Ljava/lang/String;
    invoke-static {v6, v7}, Landroid/media/MediaScanner;->access$502(Landroid/media/MediaScanner;Ljava/lang/String;)Ljava/lang/String;
    ...
    #setter for: Landroid/media/MediaScanner;->isDrmFile:Z
    invoke-static {v6, v7}, Landroid/media/MediaScanner;->access$602(Landroid/media/MediaScanner;Z)Z
    ...
    #setter for: Landroid/media/MediaScanner;->canForward:Z
    invoke-static {v6, v7}, Landroid/media/MediaScanner;->access$702(Landroid/media/MediaScanner;Z)Z
    ...
    #setter for: Landroid/media/MediaScanner;->isDrmAudio:Z
    invoke-static {v6, v7}, Landroid/media/MediaScanner;->access$802(Landroid/media/MediaScanner;Z)Z
    ...
    #setter for: Landroid/media/MediaScanner;->isCricketDrmRingtone:Z
    invoke-static {v6, v7}, Landroid/media/MediaScanner;->access$902(Landroid/media/MediaScanner;Z)Z
    ...
    #setter for: Landroid/media/MediaScanner;->isDrmImage:Z
    invoke-static {v6, v7}, Landroid/media/MediaScanner;->access$1002(Landroid/media/MediaScanner;Z)Z
    ...
    #setter for: Landroid/media/MediaScanner;->isDrmVideo:Z
    invoke-static {v6, v7}, Landroid/media/MediaScanner;->access$1102(Landroid/media/MediaScanner;Z)Z
...
.method public doScanFile(Ljava/lang/String;Ljava/lang/String;JJZ)Landroid/net/Uri;
    ...
    invoke-static {v0, p1, p2, p0}, Landroid/media/MediaScanner;->access$1200(Landroid/media/MediaScanner;Ljava/lang/String;Ljava/lang/String;Landroid/media/MediaScannerClient;)V
    ...
    iget v7, p0, Landroid/media/MediaScanner$MyMediaScannerClient;->mFileType:I
    ...
    #calls: Landroid/media/MediaScanner;->processDCFFile(Ljava/lang/String;Ljava/lang/String;Landroid/media/MediaScannerClient;)V
    invoke-static {v0, p1, p2, p0}, Landroid/media/MediaScanner;->access$1300(Landroid/media/MediaScanner;Ljava/lang/String;Ljava/lang/String;Landroid/media/MediaScannerClient;)V

    .line 595
    :cond_3
    iget-object v0, p0, Landroid/media/MediaScanner$MyMediaScannerClient;->this$0:Landroid/media/MediaScanner;

    #getter for: Landroid/media/MediaScanner;->isCricketDrmRingtone:Z
    invoke-static {v0}, Landroid/media/MediaScanner;->access$900(Landroid/media/MediaScanner;)Z
    ...
    const-string v8, "The Cricket\'s DRM ringtone : "

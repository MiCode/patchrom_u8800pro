...
# static fields
.field private static final ACTION_RESUMETOPACTIVITY:Ljava/lang/String; = "com.carrieriq.action.resumeTopActivity"

.field private static final ACTION_STARTACTIVITY:Ljava/lang/String; = "com.carrieriq.action.startActivity"
...
.field static final DEFAULT_APPNUM_TASK:I = 0xa

.field static DEFAULT_APPNUM_TASK_STRING:Ljava/lang/String; = null

.field static DEFAULT_PACKAGE_NAME_TASK:Ljava/lang/String; = null
...
.field static PACKAGE_NAME_TASK_STRING:Ljava/lang/String; = null
...
.field static TASK_SCALE_DEN_STRING:Ljava/lang/String;

.field static TASK_SCALE_NUM_STRING:Ljava/lang/String;
...
.method static constructor <clinit>()V
    ...
    .prologue
    .line 271
    const-string v0, "default_appnum_task"

    sput-object v0, Lcom/android/server/am/ActivityStack;->DEFAULT_APPNUM_TASK_STRING:Ljava/lang/String;

    .line 272
    const-string v0, "package_name_task"

    sput-object v0, Lcom/android/server/am/ActivityStack;->PACKAGE_NAME_TASK_STRING:Ljava/lang/String;

    .line 273
    const-string v0, "com.huawei.task"

    sput-object v0, Lcom/android/server/am/ActivityStack;->DEFAULT_PACKAGE_NAME_TASK:Ljava/lang/String;

    .line 274
    const-string v0, "task_scale_num"

    sput-object v0, Lcom/android/server/am/ActivityStack;->TASK_SCALE_NUM_STRING:Ljava/lang/String;

    .line 275
    const-string v0, "task_scale_den"

    sput-object v0, Lcom/android/server/am/ActivityStack;->TASK_SCALE_DEN_STRING:Ljava/lang/String;
...
.method private final createThumbnailBitmap()Landroid/graphics/Bitmap;
    .locals 18
    ...
    .line 3747
    .local v12, scalingSizeDefault:F
    :goto_3
    move-object/from16 v0, p0
    ...
    sget-object v16, Lcom/android/server/am/ActivityStack;->TASK_SCALE_NUM_STRING:Ljava/lang/String;

    const/16 v17, 0x0

    invoke-static/range {v15 .. v17}, Landroid/provider/Settings$Systemex;->getInt(Landroid/content/ContentResolver;Ljava/lang/String;I)I

    move-result v10

    .line 3748
    .local v10, scaleSizeNum:I
    move-object/from16 v0, p0
    ...
    sget-object v16, Lcom/android/server/am/ActivityStack;->TASK_SCALE_DEN_STRING:Ljava/lang/String;
    ...
    invoke-static {v4, v2, v15}, Landroid/graphics/Bitmap;->createBitmap(IILandroid/graphics/Bitmap$Config;)Landroid/graphics/Bitmap;
    ...
    .line 3763
    invoke-virtual {v1}, Landroid/graphics/Canvas;->drawFB()V
    ...
    .end local v9           #scaleSizeDen:I
    .end local v10           #scaleSizeNum:I
    .end local v11           #scalingSize:F
    .end local v12           #scalingSizeDefault:F
    .end local v14           #w:I
    :goto_5
    return-object v13
    ...
    .line 3752
    .restart local v9       #scaleSizeDen:I
    .restart local v10       #scaleSizeNum:I
    .restart local v12       #scalingSizeDefault:F
    :cond_6
    ...
    .restart local v11       #scalingSize:F
    goto :goto_4
...
.method final activityDestroyed(Landroid/os/IBinder;)V
    ...
    .line 3345
    const-string v5, "ro.config.Huawei_Task_Manager"
    ...
    .line 3346
    iget-object v5, v3, Lcom/android/server/am/ActivityRecord;->thumbnail:Landroid/graphics/Bitmap;
    ...
    iput-object v5, v3, Lcom/android/server/am/ActivityRecord;->thumbnail:Landroid/graphics/Bitmap;

    .line 3349
    const-string v5, "ActivityManager"

    const-string v6, "activityDestroyed() r.thumbnail.recycle()"
...
.method final activityPaused(Landroid/os/IBinder;Landroid/os/Bundle;Z)V
    ...
    iput-object v11, v6, Lcom/android/server/am/ActivityRecord;->state:Lcom/android/server/am/ActivityStack$ActivityState;

    .line 779
    const-string v11, "ro.config.Huawei_Task_Manager"
    ...
    const-string v12, "Java BEGIN: createThumbnailBitmap()"
    ...
    sget-object v12, Lcom/android/server/am/ActivityStack;->PACKAGE_NAME_TASK_STRING:Ljava/lang/String;

    invoke-static {v11, v12}, Landroid/provider/Settings$Systemex;->getString(Landroid/content/ContentResolver;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v8

    .line 785
    .local v8, taskPackageName:Ljava/lang/String;
    if-nez v8, :cond_1

    .line 786
    sget-object v8, Lcom/android/server/am/ActivityStack;->DEFAULT_PACKAGE_NAME_TASK:Ljava/lang/String;
    ...
    iget-object v13, p0, Lcom/android/server/am/ActivityStack;->mHistory:Ljava/util/ArrayList;
    ...
    sget-object v12, Lcom/android/server/am/ActivityStack;->DEFAULT_APPNUM_TASK_STRING:Ljava/lang/String;

    const/16 v13, 0xa

    invoke-static {v11, v12, v13}, Landroid/provider/Settings$Systemex;->getInt(Landroid/content/ContentResolver;Ljava/lang/String;I)I
    ...
    .line 791
    .end local v5           #k:I
    .end local v7           #taskNum:I
    .end local v9           #taskSize:I
    :cond_4
    iget-object v11, v6, Lcom/android/server/am/ActivityRecord;->intent:Landroid/content/Intent;
    ...
    .line 825
    .end local v8           #taskPackageName:Ljava/lang/String;
    :cond_5
    :goto_1
    const-string v11, "ActivityManager"

    const-string v12, "Java END: createThumbnailBitmap()"
    ...
    .restart local v7       #taskNum:I
    .restart local v8       #taskPackageName:Ljava/lang/String;
    .restart local v9       #taskSize:I
    :cond_8
    if-lt v9, v7, :cond_a
    ...
    iget-object v11, v2, Lcom/android/server/am/ActivityRecord;->thumbnail:Landroid/graphics/Bitmap;
    ...
    iput-object v11, v2, Lcom/android/server/am/ActivityRecord;->thumbnail:Landroid/graphics/Bitmap;

    .line 818
    .end local v2           #activityRecord:Lcom/android/server/am/ActivityRecord;
    .end local v4           #j:I
    :cond_a
    iget-object v11, v6, Lcom/android/server/am/ActivityRecord;->thumbnail:Landroid/graphics/Bitmap;
    ...
    iput-object v11, v6, Lcom/android/server/am/ActivityRecord;->thumbnail:Landroid/graphics/Bitmap;

    .line 822
    :cond_b
    invoke-direct {p0}, Lcom/android/server/am/ActivityStack;->createThumbnailBitmap()Landroid/graphics/Bitmap;
    ...
    iget-object v14, p0, Lcom/android/server/am/ActivityStack;->mPausingActivity:Lcom/android/server/am/ActivityRecord;

    if-eqz v14, :cond_d

    iget-object v14, p0, Lcom/android/server/am/ActivityStack;->mPausingActivity:Lcom/android/server/am/ActivityRecord;

    iget-object v14, v14, Lcom/android/server/am/ActivityRecord;->shortComponentName:Ljava/lang/String;
...
.method public checkScreenIdle()V
    ...
    const-string v7, "android.intent.action.stk.idle_screen"
    ...
    invoke-virtual {v3, v8}, Landroid/content/Intent;->hasCategory(Ljava/lang/String;)Z
...
.method final moveTaskToBackLocked(ILcom/android/server/am/ActivityRecord;)Z
    ...
    invoke-virtual {v8}, Lcom/android/server/am/ActivityManagerService;->getScreenStatusRequest()Z
...
.method final resumeTopActivityLocked(Lcom/android/server/am/ActivityRecord;)Z
    ...
    sget-boolean v5, Lcom/carrieriq/iqagent/client/IQClient;->IQ_ENABLE:Z
    ...
    const-string v5, "com.carrieriq.action.resumeTopActivity"
    ...
    .line 1232
    .local v21, resumeIntent:Landroid/content/Intent;
    ...
    .line 1266
    .end local v21           #resumeIntent:Landroid/content/Intent;
    :cond_6
    :goto_1
    if-eqz p1, :cond_12
...
.method final startActivityLocked(Landroid/app/IApplicationThread;Landroid/content/Intent;Ljava/lang/String;[Landroid/net/Uri;ILandroid/content/pm/ActivityInfo;Landroid/os/IBinder;Ljava/lang/String;IIIZZ)I
    ...
    const-string v5, "com.carrieriq.action.startActivity"
    ...
    .line 2000
    .local v31, startActivityIntent:Landroid/content/Intent;
    ...
    .line 2008
    .end local v31           #startActivityIntent:Landroid/content/Intent;
    :cond_1
    const/16 v30, 0x0
...
.method final startActivityMayWait(Landroid/app/IApplicationThread;Landroid/content/Intent;Ljava/lang/String;[Landroid/net/Uri;ILandroid/os/IBinder;Ljava/lang/String;IZZLandroid/app/IActivityManager$WaitResult;Landroid/content/res/Configuration;)I
    ...
    invoke-virtual {v4}, Lcom/android/server/am/ActivityManagerService;->getScreenStatusRequest()Z

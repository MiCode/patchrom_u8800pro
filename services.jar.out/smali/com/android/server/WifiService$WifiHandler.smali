...
.method public handleMessage(Landroid/os/Message;)V
    ...
    invoke-static {v1, v4, v2, v3}, Lcom/android/server/WifiService;->access$2000(Lcom/android/server/WifiService;ZZI)Z

    .line 2407
    iget-object v1, p0, Lcom/android/server/WifiService$WifiHandler;->this$0:Lcom/android/server/WifiService;

    #getter for: Lcom/android/server/WifiService;->mWifiWatchdogService:Lcom/android/server/WifiWatchdogService;
    invoke-static {v1}, Lcom/android/server/WifiService;->access$2100(Lcom/android/server/WifiService;)Lcom/android/server/WifiWatchdogService;
    ...
    invoke-static {v1, v2}, Lcom/android/server/WifiService;->access$2102(Lcom/android/server/WifiService;Lcom/android/server/WifiWatchdogService;)Lcom/android/server/WifiWatchdogService;

    .line 2410
    :cond_0
    invoke-static {}, Lcom/android/server/WifiService;->access$2200()Landroid/os/PowerManager$WakeLock;
    ...
    #calls: Lcom/android/server/WifiService;->setWifiEnabledBlocking(ZZI)Z
    invoke-static {v1, v5, v2, v3}, Lcom/android/server/WifiService;->access$2000(Lcom/android/server/WifiService;ZZI)Z
    ...
    .line 2440
    :pswitch_5
    invoke-static {}, Lcom/android/server/WifiService;->access$2500()Landroid/os/PowerManager$WakeLock;
    ...
    invoke-static {v1, v4, v2, p0}, Lcom/android/server/WifiService;->access$2600(Lcom/android/server/WifiService;ZILandroid/net/wifi/WifiConfiguration;)Z
    ...
    #calls: Lcom/android/server/WifiService;->setWifiApEnabledBlocking(ZILandroid/net/wifi/WifiConfiguration;)Z
    invoke-static {v1, v5, v2, p0}, Lcom/android/server/WifiService;->access$2600(Lcom/android/server/WifiService;ZILandroid/net/wifi/WifiConfiguration;)Z
    ...
    invoke-static {v1, v2, v3}, Lcom/android/server/WifiService;->access$2700(Lcom/android/server/WifiService;IZ)Z
    ...
    invoke-static {v1, p0}, Lcom/android/server/WifiService;->access$2800(Lcom/android/server/WifiService;Landroid/net/wifi/WifiConfiguration;)V
    ...
    invoke-static {v1}, Lcom/android/server/WifiService;->access$2900(Lcom/android/server/WifiService;)V
